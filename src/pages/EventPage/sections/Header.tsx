...
const Header = ({item}: HeaderProps) => {
    ...
    return (
        <div className={`flex justify-center bg-darkgray z-30 fixed flex-col xl:flex-row
            ...
            w-[320px] h-[133px] top-[64px]  xl:w-[1166px] xl:h-[110px] xl:top-[84px]`}>
            <div className="w-full flex flex-col items-center xl:flex-row gap-[15px] justify-between">
                <div className='flex gap-5 xl:gap-[73px]'>
                ...
                <TicketButton className='w-80 h-[45px] xl:w-[286px] xl:h-[43px]' eventId={item.eventId}/>
            </div>
        </div>
    );
};
