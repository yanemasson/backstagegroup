...
import image from '/public/images/about/image-52.webp'
    ...
    return (
        <section id='about' className='flex flex-col gap-[100px] xl:gap-40'>
            <div className='flex flex-col gap-[50px]'>
                ...
                <div className='flex flex-col lg:flex-row-reverse self-center items-center gap-[42px] xl:gap-0 xl:w-full max-w-[90vw] '>
                    ...
                    <div className='flex flex-col md:flex-row md:gap-[90px] lg:flex-col gap-[25px] lg:justify-between w-full '>
                        <div className='flex flex-col leading-tight w-[181px] xl:w-[200px] '>
                            ...
                            <p className='font-display lining-nums text-light-brown text-[68px] xl:text-[100px] tracking-[0.07em]'>12</p>
                        </div>
                        <div className='flex flex-col leading-tight xl:w-[260px] '>
                            <Text variant={TextVariant.P}>Зрителей<br/>в общей сумме</Text>
                            <p className='font-display lining-nums text-light-brown text-[68px] xl:text-[100px] tracking-[0.07em]'>4868</p>
                        </div>
                    </div>
                </div>
            </div>
