...
const RefundPage = () => {
    return (
        <>
            ...
            <div className='flex flex-col w-[90vw] xl:w-[1152px] items-start gap-10 mt-[76px]'>
                <div className=' flex flex-col items-start justify-center gap-5 pt-20 px-5 xl:px-0'>
                    ...
                    <Text variant={TextVariant.Body_M}>Уважаемые зрители! Если Вы хотите вернуть билет, выберите, пожалуйста,
                    ...
                    <Text variant={TextVariant.Body_M}>
                        ...
                        <Anchor href={'https://radario.ru/customer/refunds/submit'}>
                            ВОСПОЛЬЗУЙТЕСЬ ФОРМОЙ ВОЗВРАТА
