    ...
    return (
        <section className='flex flex-col gap-11 w-[90vw] xl:w-full'>
            ...
            <div className='flex flex-col xl:flex-row gap-8 items-center justify-between'>
                <img className='xl:w-[667px]' alt={'Насладитесь чистотой и мощью каждого звука'} src='/images/about/image-1.jpg'/>
            ...
            <div className='flex flex-col xl:flex-row gap-8 items-center justify-between'>
                <img className='xl:w-[667px]' alt={'Полное погружение в атмосферу музыки'} src='/images/about/image-2.jpg'/>
                <div className='flex flex-col gap-3'>
            ...
            <div className='flex flex-col xl:flex-row gap-8 items-center justify-between'>
                <img className='xl:w-[667px]' alt={'Живые вокальные номера'} src='/images/about/image-3.jpg'/>
                <div className='flex flex-col gap-3'>
