    ...
    return (
        <section className='flex flex-col w-[90vw] md:w-[1166px] gap-[50px]'>
            ...
            <div className='flex flex-col md:flex-row-reverse items-center justify-between'>
                <img className='mb-[30px] md:mb-0 md:w-[583px]' alt={'Насладитесь чистотой и мощью каждого звука'} src='/images/about/image-1.png'/>
            ...
            <div className='flex flex-col md:flex-row items-center justify-between'>
                <img className='mb-[30px] md:mb-0 md:w-[583px] ' alt={'Полное погружение в атмосферу музыки'} src='/images/about/image-2.png'/>
                <div className='md:w-[455px]'>
            ...
            <div className='flex flex-col md:flex-row-reverse items-center justify-between'>
                <img className='mb-[30px] md:mb-0 md:w-[583px] ' alt={'Живые вокальные номера'} src='/images/about/image-3.png'/>
                <div className='md:w-[455px]'>
